...
export class HelloPanel {
  ...
  public static createOrShow(extensionUri: vscode.Uri) {
    ...
    if (HelloPanel.currentPanel) {
      ...
      HelloPanel.currentPanel._update();
      return;
    }
  ...
  public static kill() {
    HelloPanel.currentPanel?.dispose();
  ...
  private _getHtmlForWebview(webview: vscode.Webview) {
    ...
    return `<!DOCTYPE html>
        ...
        -->
        <meta http-equiv="Content-Security-Policy" content="img-src https: data:; style-src 'unsafe-inline' ${webview.cspSource}; 'nonce-${nonce}';">
